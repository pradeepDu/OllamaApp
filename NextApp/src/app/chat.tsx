...
const OllamaChat: React.FC = () => {
  ...
  // Parse content with code block detection
  ...
  if (!user) return null;
    return (
      <AuroraBackground>
        <div className="w-[48rem] mx-auto p-6 bg-black/80 backdrop-blur-md shadow-lg rounded-xl"> {/* Fixed width */}
          ...
          <motion.div
            className="border-2 border-gray-800 rounded-lg p-4 h-[32rem] w-full overflow-y-auto mb-4 bg-black/50 scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-transparent" // Fixed height and width
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            <div className="flex flex-col space-y-4"> {/* Added container for messages */}
              <AnimatePresence>
          ...
          <div className="flex w-full"> {/* Full width input container */}
            <input
              type="text"
              value={input}
